...
Check if the corresponding SUMMARY.md file exists for the plan.
...
Poll for completion every 30 seconds until all agents complete.
...
- [ ] Checks SUMMARY.md existence to determine completion
